...
//omar
 ...
 public void setPhones(HashMap<Integer, String> Phones) {
    ...
    public ArrayList<General_massge> Show_my_massage(int State_id) {
     ...
     public void ReplyMessage (Massage message) throws ParseException, SQLException
    {
         DB_controller DB = DB_controller.Get_DB_controller();
         DB.Connect();
          ...
          HashMap<String, String> H = new HashMap<String, String>();
           ...
           int dateId=-1;
          H.put("sender_id", ""+message.getSenderId());
           ...
           H.put("Time", ""+timestamp2);
           H.put("Content", message.getContent());
           H.put("Type_id", ""+2);
           H.put("Parent_id", ""+0);
           DateFormat dateFormat2 = new SimpleDateFormat("yyyy/MM/dd");
           Date date1 = new Date();
            String currentdate = dateFormat2.format(date1); 
           Date convertedTime = dateFormat2.parse(currentdate);
           Timestamp timestamp = new Timestamp(convertedTime2.getTime());
           ResultSet result = DB.Select(" Date_id ", " date ", " Date = " + "'"+timestamp+"'" );
           ...
           H2.put("Reciever_id", ""+message.getReciver());
           H2.put("State_id", ""+5);
